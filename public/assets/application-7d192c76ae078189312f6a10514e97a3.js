...
(function() { this.JST || (this.JST = {}); this.JST["contacts/counter"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('Total: ',  count ,'\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["contacts/edit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="form-group">\n  <label for="first_name">First name</label>\n  <input name="first_name" type="text" value="',  first_name ,'" class="form-control" id="first_name">\n</div>\n<div class="form-group">\n  <label for="middle_name">Middle name:</label>\n  <input name="middle_name" type="text" value="',  middle_name ,'" class="form-control" id="middle_name">\n</div>\n<div class="form-group">\n  <label for="last_name">Last name:</label>\n  <input name="last_name" type="text" value="',  last_name ,'" class="form-control" id="last_name">\n</div>\n<div class="form-group">\n  <label for="phone">Phone:</label>\n  <input name="phone" type="text" value="',  phone ,'" class="form-control" id="phone">\n</div>\n<div class="form-group">\n  <label for="email">Email:</label>\n  <input name="email" type="text" value="',  email ,'" class="form-control" id="email">\n</div>\n  <div class="form-group">\n    <label for="group_id">Groups:</label>\n    <select name="group_id" class="form-control" id="group_id">\n      <option></option>\n    </select>\n  </div>\n<div class="form-group">\n  <button class="btn btn-default save">Save</button>\n  <a class="btn btn-default cancel">Cancel</a>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["contacts/item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="#" class="js-contact">',  first_name ,' ',  middle_name ,' ',  last_name ,'<a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["contacts/list"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="panel panel-default">\n  <div class="panel-heading">Contacts</div>\n  <div class="panel-body">\n    <ul class="list-unstyled">\n    </ul>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["contacts/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form>\n  <div class="form-group">\n    <label for="first_name">First name</label>\n    <input name="first_name" type="text" class="form-control" id="first_name">\n  </div>\n  <div class="form-group">\n    <label for="middle_name">Middle name:</label>\n    <input name="middle_name" type="text" class="form-control" id="middle_name">\n  </div>\n  <div class="form-group">\n    <label for="last_name">Last name:</label>\n    <input name="last_name" type="text" class="form-control" id="last_name">\n  </div>\n  <div class="form-group">\n    <label for="phone">Phone:</label>\n    <input name="phone" type="text" class="form-control" id="phone">\n  </div>\n  <div class="form-group">\n    <label for="email">Email:</label>\n    <input name="email" type="email" class="form-control" id="email">\n  </div>\n  <div class="form-group">\n    <label for="group_id">Groups:</label>\n    <select name="group_id" class="form-control" id="group_id">\n      <option></option>\n    </select>\n  </div>\n  <div class="form-group">\n    <button class="btn btn-default save">Save</button>\n    <a class="btn btn-default cancel">Cancel</a>\n  </div>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["contacts/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<dl class="dl-horizontal">\n  <dt>First name</dt>\n  <dd>',  first_name ,'</dd>\n  <dt>Middle name:</dt>\n  <dd>',  middle_name ,'</dd>\n  <dt>Last name:</dt>\n  <dd>',  last_name ,'</dd>\n  <dt>Phone:</dt>\n  <dd>',  phone ,'</dd>\n  <dt>Email:</dt>\n  <dd>',  email ,'</dd>\n  <dt>Group:</dt>\n  <dd id="group_name"></dd>\n</dl>\n<a class="btn btn-default edit">Edit</a>\n<a class="btn btn-default delete">Delete</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["groups/edit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="form-group">\n  <label for="name">Name</label>\n  <input name="name" type="text" value="',  name ,'" class="form-control" id="name">\n</div>\n<div class="form-group">\n  <button class="btn btn-default js-save">Save</button>\n  <a class="btn btn-default js-cancel">Cancel</a>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["groups/item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="#" class="js-group">',  name ,'<a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["groups/list"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="panel panel-default">\n  <div class="panel-heading">Groups</div>\n  <div class="panel-body">\n    <ul class="list-unstyled">\n    </ul>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["groups/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form>\n  <div class="form-group">\n    <label for="name">Name</label>\n    <input name="name" type="text" class="form-control" id="name">\n  </div>\n  <div class="form-group">\n    <button class="btn btn-default save">Save</button>\n    <a class="btn btn-default cancel">Cancel</a>\n  </div>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["groups/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<dl class="dl-horizontal">\n  <dt>Group name</dt>\n  <dd>',  name ,'</dd>\n</dl>\n<a class="btn btn-default js-edit">Edit</a>\n<a class="btn btn-default js-delete">Delete</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["layout/main_layout"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="container" id="contact-mmanager">\n  <div class="row">\n    <div class="col-md-12">\n      <header>\n        <h1>Contact manager</h1>\n          <div class="row">\n            <div class="col-md-4">\n              <a class="btn btn-danger" id="add-contact">Add contact</a>\n              <a class="btn btn-warning" id="add-group">Add group</a>\n            </div>\n            <div class="col-md-8">\n              <input type="text" class="form-control" id="search" placeholder="search"/>\n            </div>\n      </header>\n    </div>\n  </div>\n\n  <div class="row">\n    <div class="col-md-3">\n      <div id="list-region"></div><!--- contacts list -->\n      <div id="group-list-region"></div><!--- groups list -->\n    </div>\n\n    <div class="col-md-9">\n      <div id="message-region"></div>\n      <div id="main-region"></div><!--- main content -->\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["search/no_results"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('No results :(\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["search/results"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="panel panel-default">\n  <div class="panel-body">\n    <dl class="dl-horizontal">\n      <dt>First name</dt>\n      <dd>',  first_name ,'</dd>\n      <dt>Middle name:</dt>\n      <dd>',  middle_name ,'</dd>\n      <dt>Last name:</dt>\n      <dd>',  last_name ,'</dd>\n      <dt>Phone:</dt>\n      <dd>',  phone ,'</dd>\n      <dt>Email:</dt>\n      <dd>',  email ,'</dd>\n      <dt>Group:</dt>\n      <dd id="group_name"></dd>\n    </dl>\n  </div>\n</div>\n\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["shared/errors"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="alert alert-danger" role="alert">\n  <li>',  key ,'</li>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["shared/message"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="alert alert-danger" role="alert">\n  <li>',  message ,'</li>\n</div>\n');}return __p.join('');};
}).call(this);
